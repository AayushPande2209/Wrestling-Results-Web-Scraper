...
show_next_steps() {
    ...
    echo "     a. schema_mvp.sql"
    echo "     b. rls_policies.sql (optional for MVP)"
    echo "     c. realtime_config.sql (optional for MVP)"
    echo "     d. init_dev_data_mvp.sql (optional, for sample data)"
    echo ""
